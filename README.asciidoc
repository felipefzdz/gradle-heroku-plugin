...
----
plugins {
  id "com.felipefzdz.gradle.heroku" version "1.0"
}
----
...
buildscript {
  ...
  dependencies {
    classpath "gradle.plugin.com.felipefzdz.gradle.heroku:gradle-heroku-plugin:1.0"
  }
}
...
*N.B. Gradle 4.8 is required as minimum version.*
...
----
plugins {
  id "com.felipefzdz.gradle.heroku.base" version "1.0"
}
----
